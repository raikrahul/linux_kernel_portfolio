...
refcount_hw.o: $(deps_refcount_hw.o)

$(deps_refcount_hw.o):

refcount_hw.o: $(wildcard /usr/src/linux-headers-6.14.0-37-generic/tools/objtool/objtool)
