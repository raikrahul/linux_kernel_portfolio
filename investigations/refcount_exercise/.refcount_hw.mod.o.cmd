...
refcount_hw.mod.o: $(deps_refcount_hw.mod.o)

$(deps_refcount_hw.mod.o):

refcount_hw.mod.o: $(wildcard /usr/src/linux-headers-6.14.0-37-generic/tools/objtool/objtool)
