...
lru_mlock_hw.mod.o: $(deps_lru_mlock_hw.mod.o)

$(deps_lru_mlock_hw.mod.o):

lru_mlock_hw.mod.o: $(wildcard /usr/src/linux-headers-6.14.0-37-generic/tools/objtool/objtool)
