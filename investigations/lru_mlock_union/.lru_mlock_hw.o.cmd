...
lru_mlock_hw.o: $(deps_lru_mlock_hw.o)

$(deps_lru_mlock_hw.o):

lru_mlock_hw.o: $(wildcard /usr/src/linux-headers-6.14.0-37-generic/tools/objtool/objtool)
